...
def calculate_metrics_postgresql(curr, i):
    ...
    curr.execute(
        "insert into homework_5(timestamp, prediction_drift, num_drifted_columns, share_missing_values, column_quantile_metric) values (%s, %s, %s, %s, %s)",
        (
